                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="place" name="place"
                                placeholder="ketik nama tempat" value="{{ $notulen->place }}">
                        </div>
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="chairman" name="chairman"
                                placeholder="ketik nama pimpinan musyawarah" value="{{ $notulen->chairman }}">
                        </div>
                    </div>
                </div>
                <div class="mt-4">
                ...
                <div class="row align-items-end mt-4">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="keputusan" name="keputusan"
                            placeholder="ketik keputusan" value="{{ $notulen->keputusan }}">
                    </div>
                    <div class="col">
                        <label for="keterangan" class="form-label">Keterangan</label>
                        <select class="form-select" name="keterangan" id="keterangan">
                            <option value="" disabled selected>Pilih keterangan</option>
                            <option value="Eksekusi" {{ $notulen->keterangan == 'Eksekusi' ? 'selected' : '' }}>
                                Eksekusi
                            </option>
                            <option value="Eskalasi" {{ $notulen->keterangan == 'Eskalasi' ? 'selected' : '' }}>
                                Eskalasi</option>
                        </select>
                    </div>
                    <div class="col">
