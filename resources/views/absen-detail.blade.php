            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col text-end">
                        ...
                        <a href="#" onclick="confirmDownload(event, '{{ route('presence-detail.export-pdf', $notulen->id) }}')" class="btn btn-danger">
                    ...
                    <tbody class="table-secondary">
                        ...
                        <tr>
                            ...
                            @if ($detail->tanda_tangan)
                                <img src=" {{ asset('uploads/tanda_tangan/'.$detail->tanda_tangan) }}" alt="tanda_tangan" width="150px">
                            @endif
                            </td>
                        </tr>
                        @endforeach
