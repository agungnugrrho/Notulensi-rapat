...
<head>
    ...
    <style>
        .custom-swal-icon {
          width: 50px !important;  /* Lebar ikon lebih kecil */
          height: 50px !important; /* Tinggi ikon lebih kecil */
        }

        .custom-swal-popup {
          padding: 10px !important; /* Kurangi padding agar tampilan lebih compact */
        }
    </style>
    {{-- batas css --}}
                        ...
                        @else
                            @foreach ($notulens as $notulen)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('notulen.edit', $notulen->id) }}" class="btn btn-sm btn-primary" title="Edit">
                                            <i class="bi bi-pencil-square fs-5"></i>
                                        </a>
                                        <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop" onclick="loadNotulen({{ $notulen->id }})" title="Detail">
                                            <i class="bi bi-info-circle-fill fs-5"></i>
                                        </a>
                                        <a href="{{ route('absen.index', $notulen->id) }}" class="btn btn-sm btn-primary" title="Absen">
