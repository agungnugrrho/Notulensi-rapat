                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="chairman" name="chairman"
                                placeholder="ketik nama pimpinan musyawarah">
                        </div>
                    </div>
                </div>
                <div class="mt-4">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const requiredInputs = [{
                ...
                },
                {
                    ...
                    name: "Keterangan",
                    type: "select",
                    errorMsg: "Pilih Keterangan !"
                } // Tambahkan select keterangan
            ];
            ...
            btnSimpan.addEventListener("click", function(event) {
                ...
                requiredInputs.forEach(input => {
                    ...
                    if (element) {
                        if ((input.type === "select" && element.value === "") || element.value
                            .trim() === "") {
                            isValid = false;
                            let errorMessage = input.errorMsg ? input.errorMsg :
                                `${input.name} belum diisi!`;
